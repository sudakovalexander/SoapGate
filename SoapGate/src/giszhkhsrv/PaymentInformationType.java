...
@XmlSeeAlso({
    giszhkhsrv.PaymentDocumentDetailsType.ExecutorInformation.PaymentInformation.class,
    giszhkhsrv.ServiceDetailsType.ExecutorInformation.PaymentInformation.class
})
