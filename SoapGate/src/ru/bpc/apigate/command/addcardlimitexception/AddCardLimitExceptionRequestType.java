...
import ru.bpc.apigate.general.LimitExceptionType;


/**
 * <p>Java class for addCardLimitExceptionRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="addCardLimitExceptionRequestType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="cardIdentification" type="{http://www.bpc.ru/apigate/general/}cardIdentificationType"/&gt;
 *         &lt;element name="limitException" type="{http://www.bpc.ru/apigate/general/}limitExceptionType"/&gt;
...
@XmlType(name = "addCardLimitExceptionRequestType", propOrder = {
    "cardIdentification",
    "limitException",
    "cardAcceptorParameters"
})
public class AddCardLimitExceptionRequestType {

    @XmlElement(required = true)
    protected CardIdentificationType cardIdentification;
    @XmlElement(required = true)
    protected LimitExceptionType limitException;
    ...
    /**
     * Gets the value of the limitException property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public LimitExceptionType getLimitException() {
        return limitException;
    }

    /**
     * Sets the value of the limitException property.
     * 
     * @param value
     *     allowed object is
     *     {@link LimitExceptionType }
     *     
     */
    public void setLimitException(LimitExceptionType value) {
