...
/**
 * <p>Java class for InqConfRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InqConfRequest"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="confirmDocs" minOccurs="0"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
 *                   &lt;element name="item" type="{http://custsystems.com/integration/abs}confDocType" maxOccurs="unbounded"/&gt;
 *                 &lt;/sequence&gt;
 *               &lt;/restriction&gt;
 *             &lt;/complexContent&gt;
 *           &lt;/complexType&gt;
...
@XmlType(name = "InqConfRequest", propOrder = {
    "reqID",
    "docNumber",
    "docId",
    "docDate",
...
public class InqConfRequest {
    ...
    protected InqConfRequest.ConfirmDocs confirmDocs;
    ...
    /**
     * Gets the value of the confirmDocs property.
     * 
     * @return
     *     possible object is
     *     {@link InqConfRequest.ConfirmDocs }
     *     
     */
    public InqConfRequest.ConfirmDocs getConfirmDocs() {
        return confirmDocs;
    }

    /**
     * Sets the value of the confirmDocs property.
     * 
     * @param value
     *     allowed object is
     *     {@link InqConfRequest.ConfirmDocs }
     *     
     */
    public void setConfirmDocs(InqConfRequest.ConfirmDocs value) {
        this.confirmDocs = value;
    }
    ...
    public static class ConfirmDocs {

        @XmlElement(required = true)
        protected List<ConfDocType> item;
         ...
         * 
         */
        public List<ConfDocType> getItem() {
            if (item == null) {
                item = new ArrayList<ConfDocType>();
            }
            return this.item;
        }
