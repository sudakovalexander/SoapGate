...
public class StmFaultMsg extends Exception {
    ...
    public StmFaultMsg(String message) {
        super(message);
    }
    
    public StmFaultMsg(String message, Throwable cause) {
        super(message, cause);
    }

    public StmFaultMsg(String message, com.custsystems.integration.abs.absinterface.ErrorElement errorElement) {
        super(message);
        this.errorElement = errorElement;
    }

    public StmFaultMsg(String message, com.custsystems.integration.abs.absinterface.ErrorElement errorElement, Throwable cause) {
        super(message, cause);
        this.errorElement = errorElement;
    }
