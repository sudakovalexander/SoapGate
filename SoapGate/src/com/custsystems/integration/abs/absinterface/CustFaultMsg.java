...
public class CustFaultMsg extends Exception {
    ...
    public CustFaultMsg(String message) {
        super(message);
    }
    
    public CustFaultMsg(String message, Throwable cause) {
        super(message, cause);
    }

    public CustFaultMsg(String message, com.custsystems.integration.abs.absinterface.ErrorElement errorElement) {
        super(message);
        this.errorElement = errorElement;
    }

    public CustFaultMsg(String message, com.custsystems.integration.abs.absinterface.ErrorElement errorElement, Throwable cause) {
        super(message, cause);
        this.errorElement = errorElement;
    }
