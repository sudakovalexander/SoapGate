...
@XmlRootElement(name = "CCRatesResponse")
public class CcratesResponse {

    @XmlElement(required = true, nillable = true)
    protected CCRatesResponse response;
     ...
     *     
     */
    public CCRatesResponse getResponse() {
        return response;
    }
     ...
     *     
     */
    public void setResponse(CCRatesResponse value) {
        this.response = value;
    }
