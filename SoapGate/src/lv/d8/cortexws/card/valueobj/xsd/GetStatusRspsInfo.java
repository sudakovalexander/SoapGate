...
/**
 * <p>Java class for GetStatusRspsInfo complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetStatusRspsInfo"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GetStatusRspsInfo", propOrder = {
    "action",
    "actioncode",
    "actionmessage",
    "pan",
...
public class GetStatusRspsInfo
    extends CortexWSRspsInfo
{
    ...
    @XmlElementRef(name = "statcode", namespace = "http://valueobj.card.cortexws.d8.lv/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> statcode;
     ...
     *     
     */
    public JAXBElement<String> getStatcode() {
        return statcode;
    }
     ...
     *     
     */
    public void setStatcode(JAXBElement<String> value) {
        this.statcode = value;
    }
